...
export function PostDetailView({
  ...
  return (
    <div
      data-home-detail-fullscreen="true"
      className="flex min-h-full w-full min-w-0 max-w-none flex-col gap-6"
    >
      <section className="relative overflow-hidden rounded-[32px] border border-black/5 bg-white shadow-[0_24px_64px_rgba(15,23,42,0.08)] dark:border-white/10 dark:bg-[rgba(34,36,46,0.88)]">
        ...
        <div className="w-full border-b border-black/5 bg-[#f5f7f6] px-4 py-4 dark:border-white/10 dark:bg-black/20 sm:px-6">
          <PostMediaGallery
            post={post}
            aspectClassName={post.type === "video" ? "aspect-[16/8.2]" : "aspect-[16/9.2]"}
            className="mx-auto w-full max-w-[96rem] overflow-hidden rounded-2xl"
            showBadge={false}
            preferVideoPlayback={post.type === "video"}
          />
        </div>
